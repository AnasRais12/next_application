...
const categories = [
  {
    ...
    image:
      'https://img.freepik.com/free-vector/realistic-kitchen-interior_1284-15414.jpg?ga=GA1.1.908455001.1724928643&semt=ais_hybrid',
  },
  {
    title: 'NEW ARRIVALS',
...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-full py-16 sm:mt-16 mt-10 gap-10 overflow-hidden  bg-gray-50 flex md:flex-row items-center justify-center md:justify-between px-6 md:pl-16 lg:pl-24">
      ...
      >
        <h1 className="sm:text-4xl text-3xl md:text-4xl xl:text-6xl font-bold text-gray-900">
