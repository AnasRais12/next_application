...
const categories = [
  ...
  { 
    name: 'Shoes', 
    image: 'https://images.unsplash.com/photo-1460353581641-37baddab0fa2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80',
    bgColor: 'bg-white' 
        ...
        >
          {categories.map((category, index) => (
            <SwiperSlide key={index} className="!h-auto">
              <div className={`flex flex-col h-full items-center p-3 sm:p-4 ${category.bgColor} rounded-xl border border-gray-200/80 cursor-pointer transition-all hover:shadow-md hover:border-primary/30 hover:-translate-y-1`}>
                ...
                <h3 className="text-base sm:text-lg font-semibold text-dark text-center">{category.name}</h3>
