        ...
        <nav className=" ">
          <ul className="space-y-3 ">
            ...
            <li
              ...
              className="text-gray-300 hover:text-white hover:border-[red] cursor-pointer rounded-md border-2 py-2 px-2 mr-2 transition-colors hover:bg-[red]"
            >
              Delete
            </li>
          </ul>
            ...
            <div className="relative p-4 text-center  shadow-lg rounded-lg  dark:bg-gray-800 sm:p-5">
              ...
              <div className="flex justify-center items-center space-x-4">
                <button
                  ...
                  className="py-2 border-[#ccc] px-3 text-sm font-medium text-white bg-black rounded-lg    focus:ring-4 focus:outline-none focus:ring-primary-300 hover:text-white focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600"
                >
                  No cancel
                </button>
                <button
