                    ...
                    <div className="rounded-lg border bg-white border-gray-200 mb-4  p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 md:p-6">
                      <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                        ...
                        <div className="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                          <a
                            href="#"
                            className="text-base font-normal text-gray-900 hover:underline dark:text-white"
                          >
                            {item?.product_name}
                          </a>
                            ...
                            <div className="  overflow-y-auto overflow-x-hidden fixed flex   top-52 right-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
                              <div className="relative p-4 w-full max-w-md h-full md:h-auto">
                                <div className="relative p-4 text-center bg-gray-100 shadow-lg rounded-lg  dark:bg-gray-800 sm:p-5">
                                  <svg
                                    className="text-[red] dark:text-gray-500 w-11 h-11 mb-3.5 mx-auto"
                                    aria-hidden="true"
                                    fill="currentColor"
                                    viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg"
                                  ...
                                  <div className="flex justify-center items-center space-x-4">
                                    <button
                                      ...
                                      className="py-2 border-[#ccc]  px-3 text-sm font-medium  bg-gray-300 text-black rounded-lg    focus:ring-4 focus:outline-none focus:ring-primary-300  focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600"
                                    >
                                      No cancel
                                    </button>
                                    <button
                                      ...
                                      className="py-2 px-3 text-sm font-medium text-center text-black bg-gray-300 rounded-lg hover:bg-red-700 hover:text-white focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-900"
                                    >
