...
export default function AlertModal({ icon = 'success', title, text, buttonText = 'OK', infoButtonText = "No Cancel" }) {
    const buttonColor =
        icon === 'error' || icon === 'info'
            ...
            : icon === 'success'
                ...
                : '';
    const checkInfo = icon === 'info' ? 'flex border-[#999999] bg-white text-black border-2' : 'hidden';
    Swal.fire({
        html: `
