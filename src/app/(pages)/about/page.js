        ...
        <section className="py-16  container   mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow border-t-4 border-primary">
              ...
              <h3 className="text-xl font-semibold text-center text-dark mb-3">
                Wide Selection
              </h3>
              <p className="text-gray-600 text-center">
                Thousands of products across all categories to meet your every
                need.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow border-t-4 border-accent">
              ...
              <p className="text-gray-600 text-center">
                Industry-leading security measures to protect your data and
                transactions.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow border-t-4 border-secondary">
              ...
              <p className="text-gray-600 text-center">
                90% of orders delivered within 2-3 business days with real-time
                tracking.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow border-t-4 border-primary-dark">
              ...
              <p className="text-gray-600 text-center">
                Our customer care team is always ready to assist you with any
                questions.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                quote:
                  'ShopEase has completely transformed my shopping experience. The quality of products and delivery speed is unmatched!',
                name: 'Sarah Johnson',
                role: 'Loyal Customer since 2018',
              },
              {
                quote:
                  'I love the variety and the frequent deals. Customer service is always helpful when I have questions about products.',
                name: 'Michael Chen',
                role: 'Verified Buyer',
              },
              {
                quote:
                  'As a small business owner, I appreciate how easy it is to find what I need at competitive prices. Highly recommend!',
                name: 'David Wilson',
