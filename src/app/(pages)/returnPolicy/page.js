              ...
              content={
                <>
                  <p className="mb-3">
                    ...
                    of the purchase date for most items. To be eligible for a
                    return:
                  </p>
                  ...
                  <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded-r">
                    ...
                    <p className="text-blue-600">
                      Some items are final sale and not eligible for return,
                      including perishable goods, intimate apparel, and
                      personalized items.
                    </p>
                  </div>
                </>
              ...
              content={
                <>
                  ...
                  <p className="text-sm text-gray-500">
                    *Return shipping costs may apply unless the return is due to
                    our error
                  </p>
                </>
              }
              ...
              content={
                <>
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-gray-600 mb-3">
                    <li>
                      We will inspect the returned item within{' '}
                  ...
                  <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded-r">
                    ...
                    <p className="text-yellow-600">
                      ...
                      on your statement depending on your bank's processing
                      time.
                    </p>
                  </div>
                </>
            ...
            <PolicySection
              ...
              content={
                <>
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-gray-600 mb-3">
                    <li>
                      Different size of the same item (subject to availability)
                    </li>
                    <li>
                      Different color of the same item (subject to availability)
                    </li>
                  </ul>
                  <p>
                    To request an exchange, please contact our customer service
                    team before returning your item.
                  </p>
                </>
              }
            />
              ...
              content={
                <>
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-gray-600">
                    <li>
                      Contact us within{' '}
                      <span className="font-medium">48 hours</span> of delivery
                    </li>
                    <li>Provide photos of the damage/defect</li>
                    <li>
                      We will arrange for free return shipping and expedite your
                      replacement
                    </li>
                  </ul>
                </>
              ...
              content={
                <>
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-gray-600">
                    ...
                    <li>
                      Please mark the package as "Returned Goods" to avoid
            ...
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-200 mt-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mb-1">
                    <span className="font-medium text-emerald-600">Phone:</span>{' '}
                    +92 1100-111111 (Option 2)
                  </p>
...
const PolicySection = ({ title, content }) => (
  <section className="border-b border-gray-100 pb-8 last:border-0 last:pb-0">
    ...
    <div className="text-gray-600 space-y-4">{content}</div>
  </section>
);
