        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden mb-8 border border-gray-100">
          ...
          <div className="p-6 px-2 md:p-8">
            <p className="text-lg text-gray-600 mb-6 border-l-4 border-emerald-500 pl-4 py-2 bg-emerald-50 rounded-r">
              Welcome to <span className="font-bold text-emerald-700">Shopease</span>. Please read these Terms and Conditions carefully before using our e-commerce platform.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
          <div className="sm:p-6 p-3 md:p-8 space-y-10">
            ...
            <TermSection 
              ...
              content={
                <>
                  In order to make purchases, you must create an account on our website. You agree to provide accurate, current, and complete information during the registration process and update your information if necessary. You are responsible for maintaining the confidentiality of your account credentials.
                </>
              }
            />
            ...
            <TermSection 
              ...
              content={
                <>
                  <p className="mb-3">By placing an order on our website, you are offering to purchase products in accordance with these Terms. Once an order is placed, you will receive an order confirmation email. However, the contract is not considered complete until we dispatch the goods.</p>
                  <p>All payments must be made in full at the time of placing an order. We accept payments via credit cards, debit cards, and other payment methods as indicated on the website. You represent and warrant that you have the legal right to use the payment method.</p>
                </>
              }
            />
            ...
            <TermSection 
              ...
              content={
                <>
                  <p className="mb-3">We offer a return policy for products purchased on our platform. Products can be returned within a specified period (e.g., 30 days) from the date of delivery, subject to certain conditions (e.g., items must be in their original condition). Refunds will be issued once the returned product is inspected and accepted.</p>
                  <p>Some items, such as perishable goods or intimate products, may not be eligible for return. Please check the product page for return eligibility before making a purchase.</p>
                </>
              }
            />
            ...
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-200 mt-10">
              <h3 className="text-xl font-semibold text-emerald-700 mb-4">Contact Us</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-600">
                ...
                <div>
                  <p className="font-medium text-emerald-600">Business Hours:</p>
                  <p>Mon-Fri: 9AM - 6PM</p>
                </div>
              </div>
            </div>
