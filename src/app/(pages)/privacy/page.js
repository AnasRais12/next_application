    ...
    <div className="min-h-screen mt-16 bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-gray-100 p-8 rounded-lg shadow-md">
        ...
        <p className="text-lg text-gray-700 mb-6">
          At <span className='text-unique tracking-wide'>Shopease</span> we are committed to protecting your privacy. This Privacy Policy outlines how we
          collect, use, and protect your personal information when you visit our website and use our services.
        </p>

        <section className="space-y-6">
          <h2 className="text-2xl font-semibold text-gray-800">1. Information We Collect</h2>
          <p className="text-gray-600">
            We collect personal information when you visit our website, make a purchase, create an account, or
            interact with us in other ways. This information may include:
          </p>
          ...
          <ul className="list-disc pl-5 text-gray-600">
            ...
            <li>To communicate with you about your orders, promotions, or customer service inquiries</li>
          ...
          <p className="text-gray-600">
            ...
            These include encryption, secure payment processing, and access control to safeguard against unauthorized
          ...
          <p className="text-gray-600">
            ...
            information with trusted third-party service providers who help us operate our website and fulfill
            your orders, including:
          </p>
          <ul className="list-disc pl-5 text-gray-600">
          ...
          <p className="text-gray-600">
            We ensure that these third parties comply with our privacy standards and use your data only for the
          ...
          <p className="text-gray-600">
            ...
            files that are stored on your device to help us remember your preferences, improve functionality, and
            analyze user behavior. You can control the use of cookies through your browser settings.
          </p>
          ...
          <p className="text-gray-600">
            To exercise any of these rights, please contact us at [Your Contact Information]. We will respond to
          ...
          <p className="text-gray-600">
            ...
            this Privacy Policy, including for legal, accounting, or reporting requirements. Once your data is no
          ...
          <p className="text-gray-600">
            ...
            our website, and the date of the latest revision will be reflected at the top of this page. We encourage
          ...
          <p className="text-gray-600">
            Email: Admin33@gmail.com<br />
            Phone: +92 1100-111111<br />
