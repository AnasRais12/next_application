...
function page() {
  return (
    ...
    <div class="mx-auto w-full  md:px-8 px-3  ">
      <h2 class="xl:text-[2vw] lg:text-[2.1vw] text-[25px] sm:text-[30px] font-semibold text-gray-900 dark:text-white ">Shopping Cart</h2>
  
      <div class="mt-6 sm:mt-8 md:gap-6  lg:flex lg:items-start xl:gap-8">
        <div class=" flex-none w-full lg:w-[60%] ">
          <div class="bg-gray-300 space-y-6">
