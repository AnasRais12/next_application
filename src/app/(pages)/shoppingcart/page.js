      ...
      <div className="mt-6 sm:mt-8  md:gap-6  lg:flex lg:items-start xl:gap-8">
        <div className=" flex-none w-full lg:w-[60%] ">
          {cart.length > 0 && cart.map((item)=>(
            <div key={item?.id} className="bg-gray-900 flex flex-col   space-y-6">
            ...
            <div  className="rounded-lg border bg-white border-gray-200 mb-4  p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 md:p-6">
              <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                ...
                <div className="flex  items-center justify-between md:order-3 md:justify-end">
                  ...
                  <div className="text-end md:order-4 md:w-32">
                    <p className="text-[18px] font-bold text-gray-900 dark:text-white">${item?.Price || 0}</p>
                  </div>
                </div>
  
                <div className="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                  <a href="#" className="text-base font-medium text-gray-900 hover:underline dark:text-white">{item?.desc}</a>
