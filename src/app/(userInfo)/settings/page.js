        ...
        >
          ...
          <nav className=" ">
            <ul className="space-y-3 ">
              ...
              <li onClick={() => setchangepasswordModal(true)} className="text-gray-300 hover:text-orange-400 cursor-pointe rounded-md border-2 py-2 px-2 mr-2 transition-colors">Change Password</li>
